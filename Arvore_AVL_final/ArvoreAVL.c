...
/* ****Funções auxiliares para tratamento de inserção
e remoção em árvore AVL **** */
...
//Função labs() arrendonda valores em módulo
...
int insere_arvAVL(arvAVL *raiz, int valor){
    int res; //pega resposta das chamadas de funções
